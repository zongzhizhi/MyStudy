...
import com.example.materiatest.utils.Utils;

import java.util.ArrayList;
import java.util.List;

public class DrawOverlayDemoView2 extends View {

    public DrawOverlayDemoView2(Context context) {
        this(context, null);
    }

    public DrawOverlayDemoView2(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public DrawOverlayDemoView2(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    private void init() {
        ...
        mTopPaint.setColor(getResources().getColor(R.color.colorAccent));

        mBottomPaint = new Paint();
        mBottomPaint.setAntiAlias(true);
        mBottomPaint.setStyle(Paint.Style.FILL);
        mBottomPaint.setColor(getResources().getColor(R.color.colorPrimary));
        ...
        textBottomPaint.setColor(getResources().getColor(R.color.design_default_color_primary));

        textTopPaint = new TextPaint();
        textTopPaint.setTextAlign(Paint.Align.CENTER);
        textTopPaint.setTextSize(Utils.dp2px(30));
        textTopPaint.setColor(getResources().getColor(R.color.colorAccent));
